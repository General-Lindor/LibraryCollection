--Compares two strings and returns an integer describing their similarity
--0: Strings match
--the higher the number, the less similar they are
--This is absolute similarity and not relative. If you want relative, you need to divide it by string length
